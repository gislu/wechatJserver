...
public class Direction {
	...
	public static String translate(String source) {
		...
		// 组装查询地址
		String requestUrl = "http://api.map.baidu.com/direction/v1?mode=transit&origin=曙光新村&destination=火车站&region=合肥&output=json&ak=344b87d71c4f56a10eb9e55d331d1973";
